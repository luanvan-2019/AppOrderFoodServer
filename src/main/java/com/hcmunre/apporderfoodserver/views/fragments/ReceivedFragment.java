...
import com.hcmunre.apporderfoodserver.views.adapters.OrderReceivedAdatper;
...
public class ReceivedFragment extends Fragment implements LoadMore {
    ...
    private OrderReceivedAdatper orderAdatper;
    ...
    private void getMaxOrder(){
        Observable<MaxOrder> maxNumOrder=Observable.just(
                orderData.getMaxOrder(PreferenceUtilsServer.getUserId(getActivity()),1));
    ...
    public class getAllOrder extends AsyncTask<String,String,ArrayList<Order>> {
        ...
        protected void onPostExecute(ArrayList<Order> orders) {
            if(orders.size()>0){
                ...
                orderAdatper = new OrderReceivedAdatper(getActivity(), orderArrayList);
