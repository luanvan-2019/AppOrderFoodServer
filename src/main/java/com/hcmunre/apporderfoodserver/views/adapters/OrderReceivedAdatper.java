...
public class OrderReceivedAdatper extends RecyclerView.Adapter<OrderReceivedAdatper.ViewHolder> {
    private Context context;
    private ArrayList<Order> listOrderHistory;
    LoadMore loadMore;
    OrderData orderData=new OrderData();
    public OrderReceivedAdatper(Context context, ArrayList<Order> listOrderHistory) {
    ...
    @NonNull
    @Override
    public OrderReceivedAdatper.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_order_history,null);
        return new OrderReceivedAdatper.ViewHolder(view);
    }
